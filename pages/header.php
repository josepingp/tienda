...
<head>
    ...
    <meta name="description" content="Tienda de artículos relacionados con la practica del yoga, el pilates y la meditacion">
    <meta name="keywords" content="yoga, pilates, salud, welthness, deporte, espiritual, mujer, aviles, gijon, oviedo, asturias">
                    ...
                    <div href="#" class="icon-menu-responsive-link">
                        ...
                        <section id="nav-m-links">
                            <ul class="nav-m-items">
                                <li class="nav-m-item">
                                    <a href="/proyectos" class="nav-m-link">Home</a>
                                </li>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <form action="/proyecto/" method="POST" class="login-form">
                                                ...
                                                <input type="email" class="login-input" id="email" name="email" required>
                                                <label for="password" class="login-label">Contraseña</label>
                                                <input type="password" class="login-input" id="password" name="pass" pattern="[a-zA-Z0-9$@.-]{7,100}" required>
                                                <div id="login-btns">
        ...
        <section id="d-header">
            ...
            <nav class="d-navbar2">
                <section class="d-navbar2-container">
                    ...
                    <article class="icon-login-container">
                        <a class="login-link">login <img src="./assets/img/sinlog.png" alt="" class="default-log-img"></a>
                    </article>
                </section>
            </nav>
            <section id="login-container" class="hidden">
                ...
                <form action="/proyecto/" class="login-form" method="POST">
                    ...
                    <label for="password" class="login-label">Contraseña</label>
                    <input type="password" class="login-input" id="password" pattern="[a-zA-Z0-9$@.-]{7,100}" name="pass" required>
                    <div id="login-btns">
                        <input type="submit" class="login-button" value="Inicia sesion">
                        <a class="create-account" href="">Registrarse</a>
                    </div>
