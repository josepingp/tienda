    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary nav-underline">
        <div class="container-fluid">
            <a class="navbar-brand" href="">
                <img src="./assets/img/logo-sin-fondo.png" class="d-inline-block align-text-middle" alt="logo"
                    width="50">
                YOGUINI NANA
            </a>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#">ESTERILLAS</a></li>
                            <li><a class="dropdown-item" href="#">MANTAS</a></li>
                            <li><a class="dropdown-item" href="#">ZAFUS</a></li>
            ...
            <div class="navbar-item">
                <div class="d-flex">
                    ...
                    <a href="#" class="btn btn-primary " tabindex="-1" role="button" aria-disabled="true">INICIAR
                        SESION</a>
                    <a href="#" class="btn btn-secondary " tabindex="-1" role="button"
                        aria-disabled="true">REGISTRARSE</a>
                </div>
            </div>
