...
<body>
    <header id="m-header">
        <nav id="m-nav">
            <a class="brand" href="">
                <div class="nav-brand">
                    <img src="./logo-sin-fondo.png" class="" alt="logo" width="50">
                    <p>YOGUINI NANA</p>
                </div>
            </a>
                ...
                <div href="#" class="icon-menu-responsive-link">
                    ...
                    <section id="nav-m-links">
                        <ul class="nav-m-items">
                            <li class="nav-m-item">
                                <a href="" class="nav-m-link">Home</a>
                            </li>
                            ...
                            <li class="nav-m-item-dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="" class="dropdown-m-item">Iniciar sesion</a></li>
                                    <li><a href="" class="dropdown-m-item">Registrarse</a></li>
                                </ul>
                            </li>
                            <li class="nav-m-item">
		...
		C362.6,323.611,323.611,362.6,275.517,362.6z" />
                                    ...
                                    <div class="youtube-div">
                                        <svg class="youtube-icon" height="30px" width="50px" version="1.1" id="Layer_1"
        ...
        <nav class="d-navbar">
            ...
            <section id="d-nav-principal-section">
                <ul class="d-navbar-links">
                    <li class="d-navbar-link"><a href="">Home</a></li>
                    <li class="d-navbar-link drop">
                        <a class="nav-d-link dropdown-toggle">
                            Productos
                            <svg class="d-dropdown-arrow-down" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                viewBox="0 0 24 24">
                                <path
                                    d="m9.55 12l7.35 7.35q.375.375.363.875t-.388.875t-.875.375t-.875-.375l-7.7-7.675q-.3-.3-.45-.675t-.15-.75t.15-.75t.45-.675l7.7-7.7q.375-.375.888-.363t.887.388t.375.875t-.375.875z" />
                            </svg>
                            <svg class="d-dropdown-arrow-up" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                viewBox="0 0 24 24">
                                <path
                                    d="m9.55 12l7.35 7.35q.375.375.363.875t-.388.875t-.875.375t-.875-.375l-7.7-7.675q-.3-.3-.45-.675t-.15-.75t.15-.75t.45-.675l7.7-7.7q.375-.375.888-.363t.887.388t.375.875t-.375.875z" />
                            </svg>
                    ...
                    <li class="d-navbar-link drop">
                        ...
                        <ul class="d dropdown-menu">
                            <li><a href="" class="dropdown-d-item">Usuarios</a></li>
        ...
        <nav class="d-navbar2">
            <section class="d-navbar2-container">
                ...
                <article class="icon-login-container">
                    <a class="login-link" href="">login <img src="./sinlog.png" alt="" class="default-log-img"></a>
                </article>
            </section>
        </nav>
    </header>
    ...
    <dialog class="login-container">
        <form action="" class="login-form">
            ...
            <input type="email" class="login-input" id="email" required>
            <label for="password">Contraseña</label>
            <input type="password" class="login-input" id="password" pattern="[a-zA-Z0-9$@.-]{7,100}" required>
            <input type="submit" class="login-button" value="Inicia sesion">
            <a href="" class="register-link">Aún no tienes cuenta? Pulsa aquí para registrarte.</a>
        </form>
    </dialog>
