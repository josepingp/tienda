...
<footer>
        <div class="footer-container">
            <div class="contact">
                <div class="tel">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="20"
                        width="20" viewBox="-93.2412 -156.2325 808.0904 937.395">
                        <defs>
                            ...
                            <filter x="-.056" y="-.062" width="1.112" height="1.11" filterUnits="objectBoundingBox"
                                id="c">
                                <feGaussianBlur stdDeviation="2" in="SourceGraphic" />
                            </filter>
                            <filter x="-.082" y="-.088" width="1.164" height="1.162" filterUnits="objectBoundingBox"
                                id="d">
                        ...
                        <g fill="none" fill-rule="evenodd">
                            <g transform="matrix(1 0 0 -1 -542.696 1013.504)" fill="#000" fill-rule="nonzero"
                                filter="url(#c)">
                ...
                <div class="mail">
                    ...
                    <svg fill="#000000" height="20px" width="10px" version="1.1" id="Capa_1"
            ...
            <div class="social-media-f">
                <div>
                    <a href="https://github.com/josepingp" class="sm-img"><img src="assets\img\32px-Font_Awesome_5_brands_github.svg.png" alt="" class="icon-sc"></a>
                </div>
                <div>
                    <a href="https://github.com/josepingp" class="sm-img"><img src="assets\img\linkedin_black_logo_icon_147114.png" alt="" class="icon-sc" width="32"></a>
                </div>
                <div>
                    <a href="https://github.com/josepingp" class="sm-img"><img src="assets\img\636e0a6918e57475a843f59f_icon_clyde_black_RGB.svg" alt="" class="icon-sc" width="32"></a>
                </div>
                </div>
